                  ...
                  onPressed: () {
                    showDialog(
                      ...
                      builder: (ctx) => AlertDialog(
                        ...
                        content: const Text(
                          'This will permanently delete all your shift records from this device and the cloud. This action cannot be undone.',
                        ),
                        actions: [
                          TextButton(
                          ...
                          TextButton(
                            onPressed: () async {
                              Navigator.pop(ctx);
                              final shifts = Provider.of<ShiftsProvider>(
                                context,
                                listen: false,
                              );
                              shifts.clear();
